...
# 1 "./system_configuration.h" 1
# 13 "./system_configuration.h"
...
# 16 "./system_configuration.h" 2

# 1 "./addtional_string.h" 1
# 45 "./addtional_string.h"
char * ftoa(double f, char * buf, int precision);
void concatenate(char *a, char *b,char *c,char *result);
# 17 "./system_configuration.h" 2

# 1 "./pin_manager.h" 1
# 60 "./pin_manager.h"
void PIN_MANAGER_Initialize(void);
# 18 "./system_configuration.h" 2
...
# 20 "./system_configuration.h" 2
# 69 "./system_configuration.h"
void System_Test(void);
void A2D_Test_TO_LCD(void);
void Toggle_Test(uint16_t delay);
# 7 "system_configuration.c" 2
...
void System_Test(void)
{
     ...
     do { PORTAbits.RA2 = 1; } while(0) ;
      lcd_put_float(5.25,(0x0));
     _delay((unsigned long)((500)*(20000000/4000.0)));
    do { PORTAbits.RA2 = 0; } while(0);
     lcd_put_float(4.75,(0x0));
